...
<div class="wrapper">
    <div class="middle">
        ...
        <c:if test="${page!=null}">
            ...
            <table class="gridtable" style="width:100%;">
                <thead>
                <sec:authorize url="/view.do">
                    <tr>
                        <th colspan="4">查询结果 - [<a href="${pageContext.request.contextPath}/view.do">新增国家(地区)</a>]</th>
                    </tr>
                </sec:authorize>
                <tr>
                    <th>ID</th>
                ...
                <c:forEach items="${pageInfo.list}" var="country">
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <sec:authorize url="/view.do">
                            [<a href="${pageContext.request.contextPath}/view.do?id=${country.id}">修改</a>] -
                            </sec:authorize>
                            [<a href="${pageContext.request.contextPath}/delete.do?id=${country.id}">删除</a>]
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
